    ...
    def __call__(self, x: jnp.ndarray, alpha_as: jnp.ndarray = None, training: bool = False) -> jnp.ndarray:
        ...
        for i, size in enumerate(self.hidden_dims):
            ...
            x = LoRALayer(size, rank=self.rank, alpha_r=self.alpha_r,
                            ...
                            lora_a0=self.lora0['target_score_model']['params']['LoRA_MLP_0'][f'LoRALayer_{i}']['lora_a'],
                            lora_b0=self.lora0['target_score_model']['params']['LoRA_MLP_0'][f'LoRALayer_{i}']['lora_b'],)(x, alpha_as=alpha_as)
...
class LoRAResNet(nn.Module):
    ...
    def __call__(self, x: jnp.ndarray, alpha_as: jnp.ndarray = None, training: bool = False) -> jnp.ndarray:
        ...
        x = LoRALayer(self.hidden_dim, rank=self.rank, alpha_r=self.alpha_r,
                      ...
                      lora_a0=self.lora0['target_score_model']['params']['LoRAResNet_0']['LoRALayer_0']['lora_a'],
                      lora_b0=self.lora0['target_score_model']['params']['LoRAResNet_0']['LoRALayer_0']['lora_b'],
                      )(x, alpha_as=alpha_as)
        # add lora run
        ...
        x = LoRALayer(self.out_dim, rank=self.rank, alpha_r=self.alpha_r,
                      ...
                      lora_a0=self.lora0['target_score_model']['params']['LoRAResNet_0']['LoRALayer_1']['lora_a'],
                      lora_b0=self.lora0['target_score_model']['params']['LoRAResNet_0']['LoRALayer_1']['lora_b'],)(x, alpha_as=alpha_as)
...
class LoRAResnetBlock(nn.Module):
    ...
    def __call__(self, x, i,  rank, alpha_r,  pretrain_weights, lora0, alpha_as: jnp.ndarray = None, training: bool = False,):
        ...
        x = LoRALayer(self.features * 4, rank=rank, alpha_r=alpha_r,
                      ...
                      lora_a0=lora0['target_score_model']['params']['LoRAResNet_0'][f'LoRAResnetBlock_{i}']['LoRALayer_0']['lora_a'],
                      lora_b0=lora0['target_score_model']['params']['LoRAResNet_0'][f'LoRAResnetBlock_{i}']['LoRALayer_0']['lora_b'],)(x, alpha_as=alpha_as)
        ...
        x = LoRALayer(self.features, rank=rank, alpha_r=alpha_r,
                      ...
                      lora_a0=lora0['target_score_model']['params']['LoRAResNet_0'][f'LoRAResnetBlock_{i}']['LoRALayer_1']['lora_a'],
                      lora_b0=lora0['target_score_model']['params']['LoRAResNet_0'][f'LoRAResnetBlock_{i}']['LoRALayer_1']['lora_b'],)(x, alpha_as=alpha_as)
